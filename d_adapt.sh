# eval
pretrained_models=logs/faster_rcnn_R_101_C4/voc2clipart/phase3_sw_dsce/model_0003999.pth
...
# 47.9 -> 51.2(51.3)
pretrained_models=logs/faster_rcnn_R_101_C4/voc2clipart/phase1_swbest_refix/model_0003999.pth
...
# 49.0
pretrained_models=logs/faster_rcnn_R_101_C4/voc2clipart/phase2_swbest_refix/model_0003999.pth
...
# 50.5 -> 51.6
pretrained_models=logs/faster_rcnn_R_101_C4/voc2clipart/phase2_sw_dsce/model_0002999.pth
CUDA_VISIBLE_DEVICES=0  python d_adapt.py  --confidence-ratio-c 0.2 \
  --config-file config/faster_rcnn_R_101_C4_voc.yaml \
...
# 54.1  ->  56.1
pretrained_models=../logs/source_only/faster_rcnn_R_101_C4/voc2watercolor_comic4/model_0014999.pth
...
# 57.5
pretrained_models=logs/faster_rcnn_R_101_C4/voc2watercolor/phase1_sw_dsceplus/model_0003999.pth
...
# 39.7
pretrained_models=../logs/source_only/faster_rcnn_R_101_C4/voc2comic/model_0015999.pth
CUDA_VISIBLE_DEVICES=1 python d_adapt.py \
  --config-file config/faster_rcnn_R_101_C4_voc.yaml \
  -s VOC2007Partial ../datasets/VOC2007 VOC2012Partial ../datasets/VOC2012  \
...
# 41.0 -> 43.1
pretrained_models=logs/faster_rcnn_R_101_C4/voc2comic/phase1_sw_dsce/model_0003999.pth
CUDA_VISIBLE_DEVICES=1 python d_adapt.py --confidence-ratio-c 0.1 \
  --config-file config/faster_rcnn_R_101_C4_voc.yaml \
  -s VOC2007Partial ../datasets/VOC2007 VOC2012Partial ../datasets/VOC2012  \
  -t Comic ../datasets/comic --test ComicTest ../datasets/comic --finetune --bbox-refine \
...
pretrained_models=logs/faster_rcnn_R_101_C4/voc2comic/phase2_sw_dsceplus/model_0002999.pth
CUDA_VISIBLE_DEVICES=1 python d_adapt.py --confidence-ratio-c 0.1 \
  --config-file config/faster_rcnn_R_101_C4_voc.yaml \
  -s VOC2007Partial ../datasets/VOC2007 VOC2012Partial ../datasets/VOC2012  \
  -t Comic ../datasets/comic --test ComicTest ../datasets/comic --finetune --bbox-refine \
...
# 42.4 -> 42.6
pretrained_models=logs/faster_rcnn_R_101_C4/cityscapes2foggy/phase1/model_0002999.pth
...
# 37.0 -> 38.8
pretrained_models=logs/faster_rcnn_vgg_16/cityscapes2foggy/phase1_sw_dsce/model_0002999.pth
...
#  38.9
pretrained_models=logs/faster_rcnn_vgg_16/cityscapes2foggy/phase2_dsce/model_0003999.pth
...
# 49.3 -> 51.6 / 52.2
pretrained_models=../logs/source_only/faster_rcnn_vgg_16/sim10k2cityscapes_car_dsce/model_0013999.pth
CUDA_VISIBLE_DEVICES=1 python d_adapt.py --workers-c 8 --ignored-scores-c 0.05 0.5 --bottleneck-dim-c 256 --bottleneck-dim-b 256 \
  --config-file config/faster_rcnn_vgg_16_cityscapes.yaml \
  -s Sim10kCar ../datasets/sim10k -t CityscapesCar ../datasets/cityscapes_in_voc/  \
...
# 44.7
pretrained_models=../logs/source_only/retinanet_R_101_FPN/voc2clipart/model_0023999.pth
